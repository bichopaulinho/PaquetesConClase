...
## Exportación de Clases: RCPP_MODULE {.smaller}
...
## Compilación: Otra alternativa {.smaller}
...
CXX_STD = CXX11
```
- Previamente hay que compilar Purple. Es necesario? Recomendable para evitar problemas de compatibilidad con la tool-chain que compila los paquetes de R (sobre todo en Windows)
